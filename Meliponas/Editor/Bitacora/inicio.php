            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            <!-- Contenido -->
                            <h3 class="box-title">Bienvenido <?php echo $usuario; ?> </h3> </div>


                            <h2>Escanee el codigo QR sin eliminar esta pestaña de inicio del navegador para que genere la bitacora de la colmena que desee</h2>
