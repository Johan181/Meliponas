...
<?php 
  ...
  $idBitacora=$idColmena=$idUsuario=$colmena=$cosecha=$revision=$lim_col=$lim_meli=$a_inicio=$a_termino=$a_cantidad=$a_numero=$dosis=$inicio=$termino=$desarrollo=$miel=$cria=$abeja=$cera=$fecha=$ingredientes=$observacion="";
...
<!--
          ...
          if(isset($_POST['ejecutar']))
          {
            ...
            { ?>
              ID: <label for=""> <?php echo $idBitacora; ?> </label> <br><br>

            <?php }
          }
          ?>

          <input required type="hidden" name="id" value="<?php echo $id; ?>"> <br><br>
          <?php echo $colmena; ?> <br><br>
          Bitacora: <input required type="text" name="idBitacora" value="<?php echo $idBitacora; ?>"> <br><br> 
          Colmena: <input required type="text" name="idColmena" value="<?php echo $idColmena; ?>"> <br><br> 
  ...
  <div class="scrollmenu" id="scrollmenu">
      <table border="1" class="table table-bordered table-hover">
        ...
        {?>
          ...
          <tr>
            <td>
              <form accion="" method="post" action="agrega.php">
              ...
              <a href="../Bitacora/agrega.php?idBitacora=<?php echo $fila['idBitacora']; ?>">  <input type="button" name="ejecutar" value="Seleccionar" class="btn btn-danger"/> </a>
