        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="fa fa-bars"></i></a>
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    <li>
                        <a class="profile-pic" > <b class="hidden-xs"></b> <?php echo $usuario; ?> </a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-header -->
...
$u = "SELECT nombre, apellidoP, apellidoM FROM usuario INNER join bitacora ON usuario.`user` = bitacora.IdUsuario WHERE bitacora.idBitacora in (select idBitacora from bitacora inner join colmena on bitacora.idColmena = colmena.idColmena where bitacora.idColmena = $idColmena)";
$resu = $conexion -> query($u);
$nombre = $resu -> fetch_assoc();  
?>

<div class="scrollmenu" id="scrollmenu">
<br><br><br> RESPONSABLE: <?php echo $nombre['nombre']; ?> <?php echo $nombre['apellidoP']; ?> <?php echo $nombre['apellidoM']; ?>
<br>
...
<th> <a href="../Colmena/mostrar_foto.php?idColmena=<?php echo $fila['idColmena']; ?>"> <input type="button" name="Ver" value="Ver imagen" class="btn btn-success"></a> </th>
</tr>
</table>
</div>
