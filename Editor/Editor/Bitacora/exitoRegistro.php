            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            <!-- Contenido -->
                            <h3 class="box-title">Registro exitoso, <?php echo $usuario; ?> </h3> </div>


                            <h2>Has registrado correctamente la bitacora, ahora puedes cerrar esta pestaña para seguir haciendo bitacoras o puedes salir. </h2>
