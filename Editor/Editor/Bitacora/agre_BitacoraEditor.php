...
$u = "SELECT nombre, apellidoP, apellidoM, user FROM usuario INNER join bitacora ON usuario.`user` = bitacora.IdUsuario WHERE bitacora.idBitacora in (select idBitacora from bitacora inner join colmena on bitacora.idColmena = colmena.idColmena where bitacora.idColmena = $idColmena)";
...
<table class="table table-bordered">
    ...
    <tr>
      ...
      <th><input type="hidden" value="<?php echo $tip['user']; ?>" name="idUsuario"></th>
    </tr>
    <tr>  
